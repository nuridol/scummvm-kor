...
#ifdef SCUMMVMKOR
	{ "04401d747f1a2c1c4b388daff71ed378", "    0961ba1ff2ae245710446efb4ccb-1	kr	All?	-	KOR Version	-	sev", "", "", 535405461, Common::DE_DEU, Common::kPlatformMacintosh },
#else
...
#ifdef SCUMMVMKOR
	{ "32a433dea56b86a55b59e4ff7d755711", "    0961ba1ff2ae245710446efb4ccb-1	kr	All?	-	KOR Version	-	sev", "Demo", "Demo", -1, Common::EN_ANY, Common::kPlatformPC },
#else
...
#ifdef SCUMMVMKOR
	{ "4bedb49943df95a9c900a5a82ccbe9de", "    0961ba1ff2ae245710446efb4ccb-1	kr	All?	-	KOR Version	-	sev", "", "", -1, Common::FR_FRA, Common::kPlatformUnknown },
#else
...
#ifdef SCUMMVMKOR
	{ "55518cd73cf9c6d23ea29c51ee06bdfe", "    0961ba1ff2ae245710446efb4ccb-1	kr	All?	-	KOR Version	-	sev", "", "", -1, Common::IT_ITA, Common::kPlatformUnknown },
	{ "55e4cc866ff9046824e1c638ba2b8c7f", "    0961ba1ff2ae245710446efb4ccb-1	kr	All?	-	KOR Version	-	sev", "", "", -1, Common::RU_RUS, Common::kPlatformUnknown },
#else
...
#ifdef SCUMMVMKOR
	{ "60c7b33000059b44465b2ce104a52285", "monkey", "CD", "DUMB 0.4.0", -1, Common::KO_KOR, Common::kPlatformPC },
#endif
...
#ifdef SCUMMVMKOR
	{ "8bdb0bf87b5e303dd35693afb9351215", "    0961ba1ff2ae245710446efb4ccb-1	kr	All?	-	KOR Version	-	sev", "", "", -1, Common::DE_DEU, Common::kPlatformUnknown },
#else
...
#ifdef SCUMMVMKOR
	{ "9b7452b5cd6d3ffb2b2f5118010af84f", "    0961ba1ff2ae245710446efb4ccb-1	kr	All?	-	KOR Version	-	sev", "Demo", "Demo", 116463537, Common::EN_ANY, Common::kPlatformMacintosh },
#else
...
#ifdef SCUMMVMKOR
	{ "9d7b67be003fea60be4dcbd193611936", "    0961ba1ff2ae245710446efb4ccb-1	kr	All?	-	KOR Version	-	sev", "Demo", "Demo", 11164, Common::EN_ANY, Common::kPlatformMacintosh },
#else
...
#ifdef SCUMMVMKOR
	{ "a95baf7746f1be4985ad42126993a744", "monkey2", "", "DUMB 0.1.0", -1, Common::KO_KOR, Common::kPlatformPC },
#endif
...
#ifdef SCUMMVMKOR
	{ "e72bb4c2b613db2cf50f89ff6350e70a", "    0961ba1ff2ae245710446efb4ccb-1	kr	All?	-	KOR Version	-	sev", "", "", -1, Common::ES_ESP, Common::kPlatformUnknown },
#else
...
#ifdef SCUMMVMKOR
	{ "fe381e45117878b1e942cb876b050fd6", "    0961ba1ff2ae245710446efb4ccb-1	kr	All?	-	KOR Version	-	sev", "", "", 513243679, Common::EN_ANY, Common::kPlatformMacintosh },
#else
